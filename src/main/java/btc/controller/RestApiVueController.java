...
//	지정한 게시판 글 확인하기
	...
	public Object vueSelectBoardDetail(@RequestParam("boardIdx") int boardIdx) throws Exception {
		AxiosBoardDto board = vbService.vueSelectDetailBoard(boardIdx);
		return board;
	}
...
//	게시글 삭제하기
	...
	public void vueBoardDelete(@RequestParam("boardIdx") int boardIdx) throws Exception {
		vbService.vueDeleteBoard(boardIdx);
	}
}
